...
public class SkuAttrValueController {
    ...
    public ResponseVo<List<SaleAttrValueVo>> querySalesAttrValuesBySpuId(@PathVariable("spuId") Long spuId){
        List<SaleAttrValueVo> saleAttrValueVoList = this.skuAttrValueService.querySalesAttrValuesBySpuId(spuId);
    ...
    public ResponseVo<List<SkuAttrValueEntity>> querySearchAttrValueBuCidAndSkuId(
        ...
        List<SkuAttrValueEntity> skuAttrValueEntityList = this.skuAttrValueService.querySearchAttrValueBuCidAndSkuId(cid,skuId);
